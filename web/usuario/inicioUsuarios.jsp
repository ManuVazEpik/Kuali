            ...
            <div class="encabezado">
                ...
                <div class="contenedor-grid">
                    <div class="contenedor-producto">
                        <div class="imagen">
                            <!-- <img src="../../img/productos/Cafe 1.jpg" alt="Primer Caf�"> -->
                            <p class="texto-promocion">Solo $40.00 MXM</p>
                        </div>

                        <div class="descripcion">
                            <div class="producto">
                                <p class="texto-producto">Capuchino de Moka | Cafeter�a 1</p>
                                <hr />
                                <p class="texto-etiquetas">Capuchino | Caf� | Promociones | Moka</p>
                            </div>
                            <div class="boton">
                                <a href="">� Lo quiero !</a>
                            </div>
                ...
                <div class="contenedor-cafeterias">
                    ...
                    <div class="cafeterias">
                        ...
                        <div class="cafeteria">
                            ...
                            <a href="menuCafeteria.jsp?id_caf=<%=c.getId_caf()%>">Ver men�</a>
                        </div>
